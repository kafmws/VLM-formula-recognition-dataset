...
if __name__ == '__main__':
    ...
    args = TrainArguments(
        ...
        model="/root/dev/swift_output/datav3_norm_7200_continue/v1-20260226-151323/checkpoint-1125-merged",
        # resume_only_model="",
        ...
        logging_steps=1,
        max_length=8192,
        output_dir="./swift_output/datav3_llm_datav0_5_mlp",
        dataset_num_proc=2,
        ...
        swanlab_mode="cloud",
        swanlab_exp_name="datav3_llm_datav0_5_mlp",
        metric="acc",
    )
