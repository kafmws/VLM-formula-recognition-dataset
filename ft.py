...
if __name__ == '__main__':
    ...
    args = TrainArguments(
        ...
        model="/root/dev/swift_output/datav3_norm_aug/v2-20260225-171128/checkpoint-7200-merged",
        # resume_only_model="/root/dev/swift_output/datav0_5_aug/v4-20260222-011049/checkpoint-2250-merged",
        # resume_from_checkpoint="/root/dev/swift_output/datav3_norm_aug/v2-20260225-171128/checkpoint-7200",
        ...
        # dataset="/root/dev/data/datav0/train.jsonl",
        dataset="datav0_5_imgaug",
        lazy_tokenize=True,
        eval_steps=1000,
        train_type="lora",
        target_modules='^(language_model.*\\.(k_proj|up_proj|q_proj|down_proj|gate_proj|v_proj|o_proj))$',
        use_galore=True,
        quant_bits=4,
        ...
        logging_steps=1,
        max_length=8192,
        output_dir="./swift_output/datav3_norm_7200_continue",
        dataset_num_proc=2,
        ...
        swanlab_mode="cloud",
        swanlab_exp_name="datav3_norm_7200_continue",
        metric="acc",
    )
