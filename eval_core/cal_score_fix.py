...
class LatexSimilarityEvaluator:
    ...
    def __init__(self, dpi=300, fontsize=12, temp_dir=None, similarity_threshold=0.6, skip_inference=False):
        """
        初始化评估器
    ...
    def _generate_temp_image(self, latex_content, base_name="temp_latex"):
        ...
        """
        if self.latex_converter is None:
            self.latex_converter = LatexToImage(dpi=self.dpi, fontsize=self.fontsize)
