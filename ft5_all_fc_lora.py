...
if __name__ == '__main__':
    ...
    args = TrainArguments(
        ...
        target_modules='^(vision_model\.encoder\.layers\.\d+\.(mlp\.fc1|mlp\.fc2))|(language_model.*\\.(k_proj|up_proj|q_proj|down_proj|gate_proj|v_proj|o_proj))|(mlp1\.(1|3))$',
        use_galore=True,
        quant_bits=4,
        ...
        logging_steps=1,
        max_length=8192,
        output_dir="./swift_output/all_fc_lora_ft5",
        dataset_num_proc=2,
        ...
        model_author="kafm",
        model_name="all_fc_lora_ft5",
        report_to="swanlab",
        swanlab_token=os.environ['SWANLAB_API_KEY'],
        swanlab_project="internvl-latex",
        swanlab_mode="cloud",
        swanlab_exp_name="datav0_5_norm_imgaug_all_lora_ft5",
        metric="acc",
    )
