...
if __name__ == '__main__':
    ...
    args = TrainArguments(
        ...
        model="/root/dev/baseline/swift_output/datav0_5_norm_aug_vis/v0-20260226-012937/checkpoint-3000-merged",
        # resume_only_model="",
        resume_from_checkpoint="/root/data/dev/baseline/swift_output/datav0_5_norm_aug_ft4/v1-20260226-150808/checkpoint-900",
        ...
        target_modules="(language_model.*\\.(up_proj|v_proj|k_proj|gate_proj|q_proj|down_proj|o_proj))$|mlp1\.(1|3)$",
        # use_galore=True,
        # quant_bits=4,
        ...
        logging_steps=1,
        max_length=8192,
        output_dir="./swift_output/datav0_5_norm_aug_ft4",
        dataset_num_proc=2,
        ...
        swanlab_mode="cloud",
        swanlab_exp_name="datav0_5_norm_aug_ft4",
        metric="acc",
    )
